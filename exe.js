...
class opsys {
    ...
    Read(data) {
      ...
      console.log(data[datacount]);
        ...
        let boxid = Math.floor(row/10);
        const box = document.getElementsByClassName(`F${boxid}`);
        box[0].style.color = "rgb(26, 29, 31)";
    ...
    executeuserprogram(data) {
        ...
        while(true){
          ...
          const ra = this.addressMap(this.Ic,data);
          ...
          if (this.function === 'LR'){
            ...
            let r_count = 0;
            var dataArray = [];
            let boxid = Math.floor(operandAdd/10);
            console.log(boxid);
            const box = document.getElementsByClassName(`F${boxid}`);
            box[0].style.color = "rgb(26, 29, 31)";
            for (let i = operandAdd; i <= operandAdd + 9; i++) {
        ...
        while (i < buffer.length) {
            ...
            if (cardID === '$AMJ') {
              ...
              this.startexecution(databuffer);
                ...
                for(let i=0;i<=3;i++){
                  document.getElementById(`${this.ptr}${i}`).style.backgroundColor = "yellow";
                }
